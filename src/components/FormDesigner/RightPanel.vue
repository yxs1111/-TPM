    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <template v-if="['el-switch'].includes(activeData.__config__.tag)">
            <el-divider>设置开关</el-divider>
            <el-form-item label="打开描述">
              <el-input
                v-model="activeData.props.activeText"
                placeholder="请输入打开描述"
                clearable
                @blur="$emit('fetch-data', activeData)"
              />
            ...
            <el-form-item label="关闭描述">
              <el-input
                v-model="activeData.props.inactiveText"
                placeholder="请输入打开描述"
                clearable
                @blur="$emit('fetch-data', activeData)"
              />
            ...
            <el-form-item label="打开时的值">
              <el-input
                v-model="activeData.props.activeValue"
            ...
            <el-form-item label="关闭时的值">
              <el-input
                v-model="activeData.props.inactiveValue"
...
import TreeNodeDialog from '@/components/FormDesigner/TreeNodeDialog'
