...
export default {
  ...
  'Connect using Sequence/MessageFlow or Association': '使用"顺序/消息流"链接两个任务',
  ...
  'Parallel Multi Instance': '并行会签',
  'Sequential Multi Instance': '串行会签',
  ...
  'This maps to the process definition key.':'这里填写的是流程定义的Key(键)',
  'This maps to the task definition key.':'这里填写的是任务的Key(键)',
  ...
  'Action Debug':'动调',
  'Online Debug':'正线调试',
  'Expand Or Collapse':'展开/折叠后续流程',
  'Create Internal Process':'创建一个内部流程',
