...
export default {
  ...
  //display导入
  importNormal(params) {
    return requestApi.request_post('/cityplan/investCpDisplayVThreeDetail/importNormal', params)
  },
  //display校验
  exceptionCheck(params) {
    return requestApi.request_post('/cityplan/investCpDisplayVThreeDetail/exceptionCheck', params)
  },
  //display异常项导出
  ...
  //display保存
  save(params) {
    return requestApi.request_post('/cityplan/investCpDisplayVThreeDetailEb/save', params)
  },
  //display提交、审批
  approve(params) {
