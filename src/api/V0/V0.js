...
export default {
  ...
  getListingFee(params) {
    return requestApi.request_post('/cityplan/investCpListingVOneDetail/createCPT', params)
  },
  //获取Premium数据
  getPremium(params) {
    return requestApi.request_post('/cityplan/investCpSalesVOneDetail/createCPT', params)
  },
  //excel 导出
  exportExcel(params) {
    //二进制数据流转blob
