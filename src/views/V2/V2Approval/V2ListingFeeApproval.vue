 ...
 * @LastEditTime: 2022-06-22 12:01:50
-->
<template>
    ...
    downExcel() {
      if (this.tableData.length) {
        API.exportPageExcel({
          ...
          downloadFile(
            res,
            `${this.filterObj.month}_ListingFee_${this.filterObj.channelCode}_V2_审批.xlsx`
          ) //自定义Excel文件名
    ...
    downloadTemplate() {
      if (this.tableData.length) {
        ...
        API.exportTemplateExcel({
          ...
          downloadFile(
            res,
            `${this.filterObj.month}_ListingFee_${this.filterObj.channelCode}_V2审批.xlsx`
          ) //自定义Excel文件名
