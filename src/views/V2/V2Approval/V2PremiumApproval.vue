 ...
 * @LastEditTime: 2023-02-11 15:49:28
-->
<template>
    ...
    downExcel() {
      if (this.tableData.length) {
        API.exportPageExcel({
          ...
          downloadFile(res, `${this.filterObj.month}_Premium_${this.filterObj.channelCode}_V2_查询.xlsx`) //自定义Excel文件名
    ...
    downloadTemplate() {
      if (this.tableData.length) {
        ...
        API.exportTemplateExcel({
          ...
          downloadFile(res, `${this.filterObj.month}_Premium_${this.filterObj.channelCode}_V2审批.xlsx`) //自定义Excel文件名
