      ...
      <div class="importDialog">
        ...
        <div class="tableWrap">
          <el-table border height="400" :data="ImportData" style="width: 100%" :header-cell-style="{
            ...
            <el-table-column width="230" align="center" fixed="left" prop="judgmentContent" label="系统检验">
              <template v-slot:header>
                <div>系统检验<br><span class="subTitle">-</span></div>
              </template>
              <template>
    ...
    downExcel() {
      if (this.tableData.length) {
        API.exportPageExcel({
          ...
          downloadFile(
            res,
            `${this.filterObj.month}_DM_${this.filterObj.channelCode}_V2_审批.xlsx`
          ) //自定义Excel文件名
    ...
    downloadTemplate() {
      if (this.tableData.length) {
        ...
        API.exportTemplateExcel({
          ...
          downloadFile(
            res,
            `${this.filterObj.month}_DM_${this.filterObj.channelCode}_V2审批.xlsx`
          ) //自定义Excel文件名
