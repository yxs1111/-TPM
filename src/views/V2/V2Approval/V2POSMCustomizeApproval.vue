...
<template>
  <div class="MainContent">
    ...
    <el-table :data="tableData" :max-height="maxheight" border :header-cell-style="HeadTable" :row-class-name="tableRowClassName" style="width: 100%">
      ...
      <el-table-column width="220" align="center" prop="vtwoCostDefault" label="V2预估费用-默认(RMB)">
        <template v-slot:header>
          <div>
      ...
      <el-table-column width="220" align="center" prop="vtwoCostAdjust" label="V2预估费用-调整后(RMB)">
        <template v-slot:header>
          <div>
            V2预估费用-调整后(RMB)<br /><span class="subTitle">KA+Brand+Vendor</span>
          </div>
        </template>
        <template slot-scope="scope">
          <div>
      ...
      <div class="importDialog">
        ...
        <div class="tableWrap">
          <el-table border height="400" :data="ImportData" style="width: 100%" :header-cell-style="{
            ...
            <el-table-column width="300" fixed align="center" prop="systemJudgmentContent" label="系统检验">
              <span>检验通过</span>
            </el-table-column>
            ...
            <el-table-column width="220" align="right" prop="vtwoCostDefault" label="V2预估费用-默认(RMB)">
              <template v-slot:header>
                <div>
                  V2预估费用-默认(RMB)<br /><span class="subTitle">KA+Brand</span>
                </div>
            ...
            <el-table-column width="220" align="right" prop="vtwoCostAdjust" label="V2预估费用-调整后(RMB)">
              <template v-slot:header>
                <div>
                  V2预估费用-调整后(RMB)<br /><span class="subTitle">KA+Brand+Vendor</span>
                </div>
