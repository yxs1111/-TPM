 ...
 * @LastEditTime: 2022-09-06 17:07:32
-->
<template>
  <div class="MainContent">
    ...
    <el-table :data="tableData" :max-height="maxheight" border :header-cell-style="HeadTable" :row-class-name="tableRowClassName" style="width: 100%">
      ...
      <el-table-column width="220" align="right" prop="adjustedVol" label="V2预估用量-调整后(场)">
        <template v-slot:header>
      ...
      <div class="importDialog">
        ...
        <div class="tableWrap">
          <el-table border height="400" :data="ImportData" style="width: 100%" :header-cell-style="{
            ...
            <el-table-column width="220" align="right" prop="adjustedPrice" label="V2预估单位(RMB/Tin)">
              <template v-slot:header>
                <div>V2预估单位(RMB/Tin)<br><span class="subTitle">SKU+KA+Dist+Region</span></div>
              </template>
              <template slot-scope="scope">
                <div>
                  {{ formatNum(scope.row.adjustedPrice) }}
