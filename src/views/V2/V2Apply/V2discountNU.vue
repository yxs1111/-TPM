<template>
  <div class="MainContent">
    ...
    >
      ...
      <el-table-column width="220" align="center" prop="name" label="V1计划总销量（CTN）" />
      <el-table-column width="220" align="center" prop="name" label="V1计划费用（RMB）" />
      <el-table-column width="220" align="center" prop="name" label="V2预测总销量（CTN）" />
      <el-table-column width="220" align="center" prop="name" label="V2调整后费用（RMB）" />
      <el-table-column width="220" align="center" prop="name" label="机制类型" />
      <el-table-column width="220" align="center" prop="name" label="机制名称" />
      <el-table-column width="220" align="center" prop="name" label="活动开始时间" />
      <el-table-column width="220" align="center" prop="name" label="活动结束时间" />
      <el-table-column width="220" align="center" prop="name" label="均价差值（%）" />
      <el-table-column width="220" align="center" prop="name" label="达成率（%）" />
      <el-table-column width="220" align="center" prop="name" label="费用差值" />
      <el-table-column width="120" align="center" prop="name" label="系统判定">
        <template slot-scope="{row}">
          <div class="statusWrap">
            <img v-if="row.status" src="../../../assets/images/success.png" alt="">
            <img v-if="!row.status" src="../../../assets/images/warning.png" alt="">
            {{ row.name }}
          </div>
        </template>
      </el-table-column>
      <el-table-column width="120" align="center" prop="name" label="申请人备注" />
      <el-table-column width="220" align="center" prop="name" label="Package Owner审批意见" />
      <el-table-column width="220" align="center" prop="name" label="Finance审批意见" />
    </el-table>
    <!-- 分页 -->
