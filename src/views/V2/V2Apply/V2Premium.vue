    ...
    <div class="SelectBarWrap">
      <div class="SelectBar">
        ...
        <div class="Selectli">
          ...
          <el-select
            v-model="filterObj.supplierCode"
            clearable
            filterable
            placeholder="请选择"
          >
        ...
        <div class="Selectli">
          ...
          >
            <el-option
              v-for="(item, index) in distributorCodeArr"
              :key="index"
      ...
      <div class="importDialog">
        ...
        <div class="fileInfo">
          <div class="fileInfo">
            ...
            >
              <img
                src="@/assets/images/selectFile.png"
                alt=""
              >
      ...
      API.fileImport(formData).then((response) => {
        ...
        if (response.code == 1000) {
          if (!Array.isArray(response.data) || response.data.length === 0) {
            ...
            const importList = response.data
            ...
            const isError = this.ImportData.findIndex((item) => {
      ...
      API.formatCheck({
        ...
        if (response.code == 1000) {
          if (!Array.isArray(response.data)) {
            ...
            const isError = checkList.findIndex((item) => {
              return item.judgmentType == 'Error'
            })
