        ...
        >
            ...
            >
                <template v-slot:header>
                    <div>
                        V1计划费用(RMB)<br /><span class="subTitle"
                            >KA+Brand</span
                        >
                    </div>
                </template>
            ...
            >
                <template v-slot:header>
                    <div>
                        V3实际费用-默认(RMB)<br /><span class="subTitle"
                            >KA+Brand+Vendor</span
                        >
                    </div>
                </template>
            ...
            >
                <template v-slot:header>
                    <div>
                        V3实际费用-调整后(RMB)<br /><span class="subTitle"
                            >KA+Brand+Vendor</span
                        >
                    </div>
                </template>
            ...
            >
                <template v-slot:header>
                    <div>
                        费用差值(RMB)<br /><span class="subTitle"
                            >KA+Brand</span
                        >
                    </div>
                </template>
        ...
        infoByMainId() {
            selectAPI
                ...
                .then((res) => {
                    if (res.code === 1000) {
                        if (
                            res.data.assignee.indexOf(this.usernameLocal) >
                                -1 &&
