<template>
  ...
  <div class="MainContent">
    ...
    <el-table :data="tableData" :max-height="maxheight" border :header-cell-style="HeadTable" :row-class-name="tableRowClassName" style="width: 100%">
      ...
      <el-table-column v-slot="{row}" width="280" align="right" prop="distNoticeCostBefore" label="经销商确认函费用-谈判前(RMB) ">
      ...
      <el-table-column v-slot="{row}" width="280" align="right" prop="distNoticeCostAfter" label="经销商确认函费用-谈判后(RMB)">
    ...
    <el-dialog width="66%" class="my-el-dialog" title="导入" :visible="importVisible" @close="closeimportDialog">
      ...
      <div class="tableWrap">
        <vxe-table ref="sampleTable" border height="400" :data="dialogDataF" style="width: 100%" :header-cell-style="{
            background: '#fff',
            color: '#333',
            fontSize: '16px',
            textAlign: 'center',
          ...
          <vxe-table-column v-slot="{row}" width="280" align="right" field="distNoticeCostBefore" title="经销商确认函费用-谈判前(RMB) ">
            {{ FormateNum(row.distNoticeCostBefore) }}
          </vxe-table-column>
          ...
          <vxe-table-column v-slot="{row}" width="280" align="right" field="distNoticeCostAfter" title="经销商确认函费用-谈判后(RMB)">
            {{ FormateNum(row.distNoticeCostAfter) }}
          </vxe-table-column>
    ...
    <el-dialog width="66%" class="my-el-dialog" title="补录" :visible="supplementVisible" @close="closeimportDialog">
      ...
      <div class="tableWrap">
        <vxe-table border height="400" :data="dialogData" style="width: 100%" :header-cell-style="{
            background: '#fff',
            color: '#333',
            fontSize: '16px',
            textAlign: 'center',
...
export default {
  ...
  methods: {
    ...
    exceptionCheckComple() {
      ...
      API.exceptionCheck(formDataComple)
        .then((res) => {
          if (res.code === 1000) {
            this.uploadFileName = ''
            this.$message({
      ...
      const data = {
        ...
        distributorName:
          this.filterObj.distributorName === ''
            ...
            : this.filterObj.distributorName,
        productName:
          this.filterObj.productName === '' ? null : this.filterObj.productName,
        yearAndMonth: this.localDate,
        regionName:
