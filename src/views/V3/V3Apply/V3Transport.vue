 ...
 * @LastEditTime: 2022-11-18 17:21:04
-->
<template>
  <div class="MainContent">
    ...
    <el-table :data="tableData" :max-height="maxheight" border :header-cell-style="HeadTable" :row-class-name="tableRowClassName" style="width: 100%">
      ...
      <el-table-column width="320" align="right" prop="voneCost" label="V1计划费用(RMB)">
        <template v-slot:header>
          <div>V1计划费用(RMB)<br><span class="subTitle">KA + Brand+Dist./Region + Transport Item</span></div>
        </template>
        <template slot-scope="scope">
          <div>
      ...
      <el-table-column width="320" align="right" prop="vtwoCostAdjust" label="V2预估费用(RMB)">
        <template v-slot:header>
      ...
      <el-table-column width="320" align="right" prop="vthreeCostDefault" label="V3实际费用-默认（RMB）">
        <template v-slot:header>
      ...
      <el-table-column width="320" align="right" prop="vthreeCostAdjust" label="V3实际费用-调整后(RMB)">
        <template v-slot:header>
      ...
      <el-table-column width="270" align="left" prop="systemJudgmentContent" label="系统判定内容">
        <template v-slot:header>
      ...
      <div class="importDialog">
        ...
        <div class="tableWrap">
          <vxe-table border height="400" :data="ImportData" style="width: 100%" :header-cell-style="{
            ...
            <vxe-table-column align="center" width="600" field="cpId" title="CPID" fixed="left">
              <template v-slot:header>
                <div>CPID<br><span class="subTitle">-</span></div>
              </template>
              <template slot-scope="scope">
            ...
            <vxe-table-column width="270" align="left" field="systemJudgmentContent" title="系统判定内容">
              <template v-slot:header>
                <div>系统判定内容<br><span class="subTitle">-</span></div>
              </template>
              <template slot-scope="scope">
            ...
            <vxe-table-column width="320" align="right" field="transportItem" title="Transport item">
              <template v-slot:header>
                <div>Transport item<br><span class="subTitle">-</span></div>
              </template>
              <template slot-scope="scope">
            ...
            <vxe-table-column width="320" align="right" field="vtwoCostDefault" title="V2预估费用-默认(RMB)">
              <template v-slot:header>
                <div>V2预估费用-默认(RMB)<br><span class="subTitle"> KA + Brand+Dist./Region + Transport Item</span></div>
              </template>
              <template slot-scope="scope">
                <div>
                  {{ formatNum(scope.row.vtwoCostAdjust) }}
            ...
            <vxe-table-column width="380" align="right" field="vthreeCostAdjust" title="V3实际费用-调整后（RMB）">
              <template v-slot:header>
                <div>V3实际费用-调整后（RMB）<br><span class="subTitle"> KA + Brand+Dist./Region + Transport Item</span></div>
              </template>
              <template slot-scope="scope">
    ...
    downloadTemplate() {
      if (this.tableData.length) {
        ...
        API.downloadTemplate({
          ...
          downloadFile(
            res,
            `${this.filterObj.month}_Transport-标准_${this.filterObj.channelCode}_V3申请.xlsx`
          ) //自定义Excel文件名
