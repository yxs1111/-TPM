 ...
 * @LastEditTime: 2023-02-10 14:34:26
-->
<template>
  <div class="MainContent">
    ...
    <el-table :data="tableData" :max-height="maxheight" border :header-cell-style="HeadTable" :row-class-name="tableRowClassName" style="width: 100%">
      ...
      <el-table-column width="320" align="right" prop="actualRatio" label="V3实际合同点数-默认(%)">
        <template v-slot:header>
      ...
      <div class="importDialog">
        ...
        <div class="tableWrap">
          <el-table border height="400" :data="ImportData" style="width: 100%" :header-cell-style="{
            ...
            <el-table-column width="380" align="center" prop="costDeptName" label="费用归属部门">
              <template v-slot:header>
                <div>费用归属部门<br /><span class="subTitle">-</span></div>
              </template>
              <template slot-scope="scope">
