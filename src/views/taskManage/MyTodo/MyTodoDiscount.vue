 ...
 * @LastEditTime: 2021-12-06 15:43:12
-->
<template>
  <div class="app-container" @keyup.enter="pageList">
    ...
    <el-table ref="taskTable" v-loading="searchLoading" :data="tableData" element-loading-text="正在查询" border fit stripe height="600" highlight-current-row
      ...
      <el-table-column v-slot="{row}" label="操作" align="center" width="230" class-name="small-padding fixed-width">
        <el-button  size="mini" type="primary" @click="operateProcess(row)">
          处理任务
        </el-button>
      </el-table-column>
    </el-table>
