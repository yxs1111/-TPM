 ...
 * @LastEditTime: 2022-06-07 14:11:40
-->
<template>
  <div class="app-container">
    ...
    <el-dialog class="my-el-dialog" :title="(isEditor ? '修改' : '新增') + 'WBS Code-Entity'" :visible="dialogVisible" width="50%" v-el-drag-dialog @close="closeDialog">
