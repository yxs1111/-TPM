...
<template>
  <div class="app-container"
    ...
    <div class="SelectBarWrap">
      <div class="SelectBar">
        <div class="Selectli">
          ...
          <el-select v-model="filterObj.channel"
                     clearable
                     filterable
                     placeholder="请选择">
        ...
        <div class="Selectli">
          ...
          <el-date-picker v-model="filterObj.date"
                          clearable
                          type="month"
                          value-format="yyyyMM"
                          format="yyyyMM"
      ...
      <div class="OpertionBar">
        <el-button v-permission="permissions['get']"
                   type="primary"
                   class="TpmButtonBG"
        ...
        <div v-permission="permissions['export']"
             class="TpmButtonBG"
    ...
    <div class="TpmButtonBGWrap">
      <el-button v-permission="permissions['update']"
                 type="primary"
                 icon="el-icon-my-saveBtn"
                 class="TpmButtonBG"
                 @click="updateSave">保存</el-button>
    ...
    <el-table :data="tableData"
      ...
      <el-table-column width="300"
                       align="left"
                       prop="ruleContentAfter"
                       label="">
        <template slot-scope="scope">
          <div v-if="scope.row.ruleUnit === '∈'">
            [&nbsp;
            <el-input v-model="scope.row.startRule"
                      :class="scope.row.status?'':'noPass'"
                      style="width:60px;"
                      size="small"
                      @blur="number($event,scope.row,scope.row.startRule,scope.$index)" />%,
            <el-input v-model="scope.row.endRule"
                      style="width:60px;"
                      size="small"
                      @blur="number($event,scope.row,scope.row.endRule,scope.$index)" />%&nbsp;]
          </div>
          <div v-else>
      ...
      <div class="el-dialogContent">
        <el-form ref="ruleForm"
          ...
          <el-form-item label="渠道编号"
                        prop="channelCode">
            <el-input v-model="ruleForm.channelCode"
                      class="my-el-input"
                      placeholder="请输入" />
          ...
          <el-form-item label="渠道中文名称">
            <el-input v-model="ruleForm.channelCsName"
                      class="my-el-input"
                      placeholder="请输入" />
          </el-form-item>
          ...
          <el-form-item label="产品中文名称">
            <el-input v-model="ruleForm.productCsName"
                      class="my-el-input"
                      placeholder="请输入" />
          </el-form-item>
          <el-form-item label="档位">
            <el-input v-model="ruleForm.gear"
                      class="my-el-input"
                      placeholder="请输入" />
          </el-form-item>
          <el-form-item label="volMin">
            <el-input v-model="ruleForm.volMin"
                      class="my-el-input"
                      placeholder="请输入" />
          </el-form-item>
          <el-form-item label="所属年月">
            <el-input v-model="ruleForm.yearAndMonth"
                      class="my-el-input"
                      placeholder="请输入" />
          </el-form-item>
    ...
    <el-dialog width="30%"
               ...
               :visible="visibleAdd"
               @close="closeAdd">
      <el-form ref="ruleFormAdd"
               :model="ruleFormAdd"
               :rules="rulesAdd"
               label-width="200px">
        <el-form-item label="目标月份"
                      prop="targetYear">
          <el-date-picker v-model="ruleFormAdd.targetYear"
                          type="month"
                          value-format="yyyyMM"
                          placeholder="请选择"
                          clearable />
        </el-form-item>
        <el-form-item label="新月份"
                      prop="newYear">
          <el-select v-model="ruleFormAdd.newYear"
                     placeholder="请选择"
                     clearable>
            <el-option v-for="item in yearArr"
                       :key="item"
                       :label="item"
                       :value="item" />
          </el-select>
        ...
        <el-form-item>
          <div style="display:flex;">
            <el-button class="TpmButtonBG"
                       @click="submitFormAdd('ruleFormAdd')">新增</el-button>
            <el-button class="TpmButtonBG"
                       @click="resetFormAdd('ruleFormAdd')">重置</el-button>
          </div>
        </el-form-item>
      </el-form>
    </el-dialog>
