<template>
  <div class="app-container" @keyup.enter="search">
    ...
    >
      ...
      <el-form-item>
        <el-button v-permission="permissions['get']" @click="reset" class="TpmButtonBG"
          >重置</el-button
        >
      </el-form-item>
    </el-form>
    <div class="TpmButtonBGWrap">
      <el-button type="primary" icon="el-icon-plus" @click="openModelDialog" class="TpmButtonBG"
        >新增</el-button
      >
      <el-button type="success" icon="el-icon-plus" @click="publishModel" class="TpmButtonBG"
        >发布</el-button
      >
    </div>
    <el-table
