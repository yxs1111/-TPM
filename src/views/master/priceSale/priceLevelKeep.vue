<template>
  <div class="app-container">
    ...
    <el-table v-loading="tableLoading" :data="tableData" border :header-cell-style="HeadTable" :row-class-name="tableRowClassName" stripe style="width: 100%"
      ...
      <el-table-column width="150" align="center" prop="productCode" label="档位(箱/Tln)" />
      <el-table-column width="320" align="center" prop="productCsName" label="Vol Mix" />
      <el-table-column width="150" align="center" prop="gear" label="年月" />
      <el-table-column width="150" align="center" prop="volMix" label="创建人" />
      <el-table-column width="150" align="center" prop="actualNum" label="创建时间" />
      <el-table-column width="150" align="center" prop="createBy" label="修改人" />
      <el-table-column width="180" align="center" prop="createDate" label="修改时间" />
