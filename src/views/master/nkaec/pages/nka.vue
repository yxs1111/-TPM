<template>
  <div class="app-container" style="border-radius: 0px;">
    ...
    <div class="SelectBarWrap">
      <div class="TpmButtonBG" @click="importDataNKA" v-permission="permissions['import']">
        <img src="@/assets/images/import.png" alt="">
        <span class="text">NKA Rawdata导入</span>
      </div>
    </div>
    ...
    <!-- NKA导入 -->
    <el-dialog width="30%" class="my-el-dialog" title="NKA Rawdata导入" :visible="importVisibleNKA" @close="closeImport">
