<template>
  <div class="app-container" style="border-radius: 0px;">
    ...
    <div class="SelectBarWrap">
      <div class="TpmButtonBG" @click="importDataNKALine" v-permission="permissions['import']">
        <img src="@/assets/images/import.png" alt="">
        <span class="text">NKA Guideline导入</span>
      </div>
    </div>
    ...
    <!-- EC导入 -->
    <el-dialog width="30%" class="my-el-dialog" title="NKA Guideline导入" :visible="importVisibleNKALine" @close="closeImport">
