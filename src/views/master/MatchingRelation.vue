<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" border :max-height="maxheight" :header-cell-style="HeadTable" @selection-change="handleSelectionChange" :row-class-name="tableRowClassName"
      ...
      <el-table-column align="center" prop="brandCode" label="大区"> </el-table-column>
      <el-table-column align="center" prop="brandName" label="区域"> </el-table-column>
      <el-table-column align="center" prop="brandName" label="供应商"> </el-table-column>
      <el-table-column align="center" prop="brandName" label="创建人"> </el-table-column>
      <el-table-column align="center" prop="brandName" label="创建时间"> </el-table-column>
      <el-table-column align="center" prop="brandName" label="修改人"> </el-table-column>
      <el-table-column align="center" prop="brandName" label="修改时间"> </el-table-column>
    ...
    <el-dialog class="my-el-dialog" :title="(isEditor ? '修改' : '新增') + '匹配关系'" :visible="dialogVisible" width="50%" v-el-drag-dialog @close="closeDialog">
...
export default {
  ...
  methods: {
    ...
    getZoneList() {
      API.getMatchingRelationZone().then((res) => {
        if (res.code === 1000) {
