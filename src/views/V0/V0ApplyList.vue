  ...
  <div class="V0ApplyList">
    ...
    >
      ...
      >
        <template v-slot:header>
          <div>
            CPT均价(RMB/Tin)<br /><span class="subTitle">渠道+SKU</span>
          </div>
        </template>
      </el-table-column>
      <el-table-column
      ...
      >
        <template v-slot:header>
          <div>
            CPT总计费用1(RMB)<br /><span class="subTitle"
              >KA+SKU（EC及苏宁不参考）</span
            >
          </div>
        </template>
      </el-table-column>
      ...
      >
        <template v-slot:header>
          <div>
            档位销量占比-默认(%)<br /><span class="subTitle">KA+SKU+档位</span>
          </div>
        </template>
      </el-table-column>
      <el-table-column
      ...
      >
        <template v-slot:header>
          <div>
            档位销量-默认(ctn)<br /><span class="subTitle">KA+SKU+档位</span>
          </div>
        </template>
      </el-table-column>
      <el-table-column
      ...
      >
        <template v-slot:header>
          <div>
            档位费用-默认(RMB)<br /><span class="subTitle">KA+SKU+档位</span>
          </div>
        </template>
      </el-table-column>
      <el-table-column
      ...
      >
        <template v-slot:header>
          <div>
            档位销量占比-调整后(%)<br /><span class="subTitle"
              >KA+SKU+档位</span
            >
          </div>
        </template>
      ...
      >
        <template v-slot:header>
          <div>
            档位销量-调整后(ctn)<br /><span class="subTitle">KA+SKU+档位</span>
          </div>
        </template>
      </el-table-column>
      <el-table-column
      ...
      >
        <template v-slot:header>
          <div>
            均价2-调整后(RMB)<br /><span class="subTitle">渠道+SKU</span>
          </div>
        </template>
      </el-table-column>
      <el-table-column
      ...
      >
        <template v-slot:header>
          <div>
            费用1-调整后(RMB)<br /><span class="subTitle"
              >KA+SKU+档位（EC及苏宁不参考）</span
            >
          </div>
        </template>
      </el-table-column>
      ...
      >
        <template v-slot:header>
          <div>
            费用2-调整后(RMB)<br /><span class="subTitle"
              >KA+SKU（EC及苏宁不参考）</span
            >
          </div>
        </template>
      ...
      >
        <template v-slot:header>
          <div>
            费用差值1 (RMB)<br /><span class="subTitle"
              >KA+SKU（EC及苏宁不参考）</span
            >
          </div>
        </template>
      ...
      <div class="el-dialogContent">
        ...
        >
          ...
          <el-form-item label="Scenario" prop="dimScenario">
            <el-select
              v-model="ruleForm.dimScenario"
              placeholder="请选择"
              class="my-el-select"
            >
              <el-option
                v-for="(item, index) in yearAndMonthList"
                :key="index"
                :label="item"
                :value="item"
              />
          ...
          >
            <el-table-column fixed align="center" label="是否通过" width="100">
              <template slot-scope="scope">
                <div class="statusWrap">
                  <img
                    v-if="scope.row.judgmentType == 'Error'"
                    :src="errorImg"
                  />
                  <img
                    v-else-if="scope.row.judgmentType.indexOf('Exception') > -1"
                    :src="excepImg"
                    style="width: 25px; height: 25px"
                  />
                  <img
                    v-else-if="scope.row.judgmentType == 'Pass'"
                    :src="passImg"
                    style="width: 25px; height: 25px"
                  />
