 ...
 * @LastEditTime: 2023-02-11 16:13:00
-->
<template>
  <div class="MainContent">
    ...
    <el-table :data="tableData" :max-height="maxheight" border :header-cell-style="HeadTable" :row-class-name="tableRowClassName" style="width: 100%">
      ...
      <el-table-column width="220" align="center" prop="brandName" label="经销商">
        <template v-slot:header>
      ...
      <el-table-column width="220" align="center" prop="brandName" label="DM item">
        <template v-slot:header>
          <div>DM item<br>
      ...
      <el-table-column width="260" align="right" prop="voneCost" label="V1计划费用(RMB)">
        <template v-slot:header>
          <div>
            V1计划费用(RMB)
            <br>
            <span class="subTitle"> KA+Brand+Dist.+DM Item</span>
          </div>
        </template>
        <template slot-scope="scope">
          <div>
    ...
    downExcel() {
      if (this.tableData.length) {
        API.exportExcel({
          ...
          downloadFile(
            res,
            `${this.filterObj.month}_DM_${this.filterObj.channelCode}_V1_查询.xlsx`
          ) //自定义Excel文件名
