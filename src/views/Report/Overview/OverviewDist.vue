<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" ref="multipleTable" border :max-height="maxheight" :header-cell-style="HeadTable" :row-class-name="tableRowClassName"
      ...
      <el-table-column width="150" align="center" prop="deptCode" label="客户含税IMK" />
      <el-table-column width="150" align="center" prop="deptName" label="经销商名称" />
      <el-table-column width="150" align="center" prop="deptName" label="经销商含税IMK" />
      ...
      <el-table-column width="280" align="center" prop="customerName" label="费用承担方" />
      <el-table-column width="280" align="center" prop="customerName" label="客户扣款点数" />
      <el-table-column width="280" align="center" prop="customerName" label="支付方式" />
    </el-table>
    <!-- 分页 -->
