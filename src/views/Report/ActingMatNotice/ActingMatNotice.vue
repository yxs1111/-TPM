<!--
 * @Description: 代垫通知报表
 * @Date: 2022-01-05 11:58:06
 * @LastEditTime: 2022-01-05 13:09:38
-->
<template>
  <div class="MainContent">
    ...
    <el-table :data="tableData" border :header-cell-style="HeadTable" :row-class-name="tableRowClassName" style="width: 100%">
      <el-table-column width="420" align="center" prop="cpId" label="区域" fixed />
      <el-table-column width="120" align="center" prop="yearAndMonth" label="活动月" />
      <el-table-column width="120" align="center" prop="costTypeName" label="渠道" />
      <el-table-column width="150" align="center" prop="minePackageName" label="KA group" />
      <el-table-column width="260" align="center" prop="costItemName" label="客户系统名称" />
      <el-table-column width="120" align="center" prop="channelName" label="机制类型" />
      <el-table-column width="120" align="center" prop="customerName" label="机制名称" />
      ...
      <el-table-column width="190" align="center" prop="priceGearAmount" label="价格档位">
